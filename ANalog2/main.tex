...
\begin{titlepage}
    \begin{center}
        % Insert Makerere University logo
        \begin{figure}[H]
            \centering
...
\chapter{Experiment to investigate of the Operation of RC Oscillators.}
\section{Objectives}
\begin{enumerate}
...
\nocite{*}            % Includes all references in the .bib file, cited or not
\bibliographystyle{ieeetr}  % or any other style, such as plain, alpha, etc.
\bibliography{ref}  % Replace "your_bib_file" with the name of your .bib file
\end{document}
